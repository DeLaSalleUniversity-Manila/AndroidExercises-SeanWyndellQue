...
51. **MP Android Chart Demo** (https://github.com/DeLaSalleUniversity-Manila/mpandroidchart-SeanWyndellQue)
52. **Super Jumper** (https://github.com/DeLaSalleUniversity-Manila/superjumper-SeanWyndellQue)
53. **Super Mario (Android Clone)** (https://github.com/DeLaSalleUniversity-Manila/supermario-SeanWyndellQue)
